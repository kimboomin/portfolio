...
(function(l, f) {
    ...
    function B(a) {
        ...
        g.attachEvent("onbeforeprint", function() {
            ...
            var h, k, d;
            d = a.styleSheets;
            for (var e = [], j = d.length, g = Array(j); j--; )
                g[j] = d[j];
            for (; d = g.pop(); )
            ...
            for (g = "$1" + q + "\\:$2"; k--; )
                e = h[k] = h[k].split("}"),
                e[e.length - 1] = e[e.length - 1].replace(j, g),
                h[k] = e.join("}");
            e = h.join("{");
            ...
            for (d = []; j--; )
                h = k[j],
                g.test(h.nodeName) && d.push(h.applyElement(E(h)));
            f = d;
            c = w(a, e)
        });
    ...
    var e = {
        ...
        createDocumentFragment: function(a, b) {
            ...
            b = b || n(a);
            for (var c = b.frag.cloneNode(), d = 0, e = p(), l = e.length; d < l; d++)
                c.createElement(e[d]);
            return c
        }
    };
    ...
    if (d = !g)
        d = f.documentElement,
        d = !("undefined" == typeof f.namespaces || "undefined" == typeof f.parentWindow || "undefined" == typeof d.applyElement || "undefined" == typeof d.removeNode || "undefined" == typeof l.attachEvent);
    var F = d;
    e.type += " print";
    e.shivPrint = B;
    B(f)
